		...
		<div class="container">
        	<div class="table-wrapper">
            	...
            	<table class="table table-striped table-hover table-bordered">
                	<form method="post" action="/access/add" onsubmit="return checkSubmit();">
                        ...
                        <table  align="center">
                        	<tr>
                            	<th>
                                	...
                                	<img src="http://www.santanderrio.com.ar/banco/wcm/connect/d35019cd-5bbb-4d6f-bab2-1ed3dfd0e47b/seguridad-en-la-empresa-accesos-no-autorizados_centrales_488x330.jpg?MOD=AJPERES&CACHEID=d35019cd-5bbb-4d6f-bab2-1ed3dfd0e47b"  style="width:550px;height:300px;"> 
                            		</div>
                            	</th>
                                <th>
                            		<div class="modal-body" >                   
	                                	   	...
	                                	   	<label>Resource Name</label>
												...
												<% if (resource.size() > 0) { %>
    		                                  		<% for (int i = 0;i<resource.size();i++) { %>
    		                                  			<% Resource r1 = (Resource)resource.get(i); %>
															<option value="<%=r1.getId()%>" ><%=r1.getNameResource() %></option>
										       			<%} %>
										       	<%} %>
    	                                	</select>
    	                                </div>
            	        ...
            	        <div class="modal-footer">
                	        ...
                	        <input type="submit" id="btsubmit" class="btn btn-success" value="Add Access">
                    	</div>
                </form>
            </table>
         </div>
