            ...
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <a href="/access/add" class="btn btn-success"   data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Access</span></a>
			...
			<% if (access.size() > 0) { %>
				<% for (int i = 0;i<access.size();i++) { %>
					...
					<tr>
						...
						<td><%= a.getFecha() %></td>
                            <td>
	                    	   <a href="access/view?id=<%=a.getId()%>" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                               <a href="access/edit?id=<%=a.getId()%>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                               <a href="access/delete?id=<%=a.getId()%>"  onclick="return confirmar()" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                            </td>
            		</tr>
            	<%} %>   	 
			<%} %>   
