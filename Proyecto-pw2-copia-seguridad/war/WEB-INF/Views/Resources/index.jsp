       ...
       <div class="main_container">
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <a href="/resources/add" class="btn btn-success"   data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Resource</span></a>
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                <tbody>
     		<% List<Resource> resource = (List<Resource>)request.getAttribute("resources"); %>
			<% if (resource.size() > 0) { %>
				<% for (int i = 0;i<resource.size();i++) { %>
					...
					<tr>
                    	<td><%= i+1 %></td>
                    	<td><%= r.getId() %></td>
						<td><%= r.getNameResource() %></td>
						<td><%= r.getUrl() %></td>
                        <td><%= r.isStatus() %></td>
						<td><%= r.getFecha() %></td>
                            <td>
	                    	   <a href="resources/view?id=<%=r.getId()%>" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                               <a href="resources/edit?id=<%=r.getId()%>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                               <a href="resources/delete?id=<%=r.getId()%>"  onclick="return confirmar()" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                            </td>
            		</tr>
            	<%} %>   	 
			<%} %>   
