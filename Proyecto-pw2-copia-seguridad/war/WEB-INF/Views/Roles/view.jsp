                ...
                <div class="row">
                    <div class="col-sm-6">
					 ...
					 <div class="col-sm-6">
                        ...
                        <a href="/roles/edit?id=<%= role.getId() %>" class="btn btn-warning" data-toggle="modal"><i class="material-icons">&#xe254;</i> <span>Edit Role</span></a>
              ...
              <table class="table table-striped table-hover table-bordered">
                <form>
                    <div class="modal-header">                      
                        <h4 class="modal-title">View Role <b><%=role.getId()%></b></h4>
                    </div>
                    <table  align="center">
                        <tr>
                            ...
                            <th>
                              <div class="modal-body" >                   
                                <div class="form-group">
                                    ...
                                    <input type="text"  value="<%=role.getNameRole()%>" class="form-control" size="30" maxlength="30" disabled>
                                </div>
                                <div class="form-group">
                                    <label>Description Role</label>
                                    <textarea name="description" rows="5" cols="15"  class="form-control" disabled><%=role.getDescription()%></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Status</label><br>
                                    	<input name="status" type="radio" id="actived" value="true" <% if (role.isStatus()==true)%><%{%> checked<%}%> disabled> Actived<br>
                                    	<input name="status" type="radio" id="disabled" value="false" <% if (role.isStatus()==false)%><%{%>checked <%}%> disabled> Disabled
                                </div>
                                <div class="form-group">
                                    <label>Created</label>
                                    <input type="text" value="<%=role.getFecha()%>" class="form-control" disabled>
                                </div>
