		...
		<div class="container">
        	<div class="table-wrapper">
            	...
            	<table class="table table-striped table-hover table-bordered">
                	<form method="post" action="/roles/add" onsubmit="return checkSubmit();">
                                ...
                                <th>
                            		<div class="modal-body" >                   
	                                	<div class="form-group">
                                    		...
                                    		<input name="nameRole" type="text"  autofocus class="form-control" size="30" maxlength="30" required>
                                		</div>
                                		<div class="form-group">
            	        ...
            	        <div class="modal-footer">
                	        ...
                	        <input type="submit" id="btsubmit" class="btn btn-success" value="Add Role">
                    	</div>
                </form>
            </table>
         </div>
