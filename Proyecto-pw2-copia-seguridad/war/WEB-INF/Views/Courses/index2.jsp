	...
	<body>		
		...
		<div id="fh5co-main">		
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<h2>Cursos de Robotica, Electronica y mas</h2>
						<br>
						<div class="row">						
							...
							<% if (courses.size() > 0) { %>
								<% for (int i = 0;i<courses.size();i++) { %>
									...
									<div class="col-md-6">
										<p><a href="" class="image-popup"><img src="<%=c.getBanner()%>" alt="<%= c.getCourseName() %>" class="img-responsive img-rounded">Acceder a Curso</a></p>
					...
					<div class="col-md-4">
						<div class="fh5co-sidebox">
							<h3 class="fh5co-sidebox-lead">Lista de Cursos Disponibles</h3>	
							<ul class="fh5co-post">
								<% if (courses.size() > 0) { %>
									<% for (int i = 0;i<courses.size();i++) { %>
										<% Courses c = (Courses)courses.get(i); %>
										<li>
											<a href="/actividad-page?id=<%=c.getId()%>">
											<div class="fh5co-post-media"><img src="<%=c.getBanner()%>" alt="<%= c.getCourseName() %>"></div>
											<div class="fh5co-post-blurb"> 
												<%= c.getCourseName() %>
												<span class="fh5co-post-meta"><%= c.getDateInicio() %></span>
											</div>
											</a>
										</li>
										<%} %>   	 
