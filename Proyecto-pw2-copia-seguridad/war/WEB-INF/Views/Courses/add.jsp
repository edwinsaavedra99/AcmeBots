		...
		<div class="container">
        	<div class="table-wrapper">
            	...
            	<table class="table table-striped table-hover table-bordered">
                	<form method="post" action="/courses/add" onsubmit="return checkSubmit();">
                        ...
                        <table  align="center">
                        	<tr>
                            	<th>
                                	...
                                	<img src="http://amiagencia.com/includes/frontend/ami/media/press/91/cursos-certificaciones-blog.jpg"  style="width:450px;height:450px;"> 
                            		</div>
                            	</th>
                                <th>
                            		...
                            		<div class="modal-body" >
                            			<div class="form-group">
                                    		<label>Name</label>
                                    		<input name="nameCourse" type="text" autofocus class="form-control" required>
                                		</div>                   
	                                	<div class="form-group">
                                    		<label>Rugro</label>
                                    		<input name="rugro" type="text" class="form-control" required>
                                		</div>
                                		<div class="form-group">
                                    		<label>Duracion</label>
                                    		Semanas <input name="duracion" type="number" class="form-control" required>
                                		</div>
