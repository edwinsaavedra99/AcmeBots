            	...
            	<div class="table-title">
                	<div class="row">
                    	...
                    	<div class="col-sm-6">
	                        ...
	                        <a href="/courses/view?id=<%= course.getId() %>" class="btn btn-warning" data-toggle="modal"><i class="material-icons">&#xe8f4;</i><span>View Course</span></a>
	                        <a href="/courses/delete?id=<%= course.getId() %>" onclick="return confirmar()" class="btn btn-primary" data-toggle="modal"><i class="material-icons">&#xe14c;</i> <span>Delete Course</span></a>
                    	</div>
            	    </div>
            	</div>
            	<br>
            	<table class="table table-striped table-hover table-bordered">
                	<form method="post" action="/courses/actividad?id=<%=course.getId()%>" onsubmit="return checkSubmit();">
                        ...
                        <table  align="center">
                        	<tr>
                            	<th>
                                	...
                                	<img src="https://deconceptos.com/wp-content/uploads/2008/11/concepto-de-actividad.jpg"  style="width:450px;height:450px;"> 
                            		</div>
                            	</th>
                                <th>
                            		...
                            		<div class="modal-body" >
	                                	...
	                                	<div class="form-group">
                                    		<label>Tutor</label>
                                    		<input name="tutor" type="text" class="form-control" required>
                                		</div>
                                		<div class="form-group">
            	        ...
            	        <div class="modal-footer">
                	        ...
                	        <input type="submit" id="btsubmit" class="btn btn-success" value="Add Actividad">
                    	</div>
                </form>
            </table>
         </div>
