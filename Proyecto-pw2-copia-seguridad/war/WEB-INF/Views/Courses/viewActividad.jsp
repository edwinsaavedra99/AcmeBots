...
<!DOCTYPE html>
 <html class="no-js"> 
	...
	<title>AB | Cursos de Robotica</title>
			...
			<div class="container-fluid">
				...
				<div id="fh5co-navbar" class="navbar-collapse collapse" >
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="active"><a href="/courses-page"><span>Cursos de Robótica<span class="border"></span></span></a></li>
						...
						<li><a href="/users/login"><span>Login<span class="border"></span></span></a></li>
					</ul>
				</div>
			</div>
		</nav>
	...
	<div id="fh5co-main">
		...
		<div class="container">
			<div class="row">
				<div >
					<div align="center">>
						<img alt="imagen del curso" src="<%= course.getBanner() %>" style="width:550px;height:450px;">
					</div>
					<br><br><br>
  ...
  <tr>
		<th scope="row">inicio</th>
			<td>Incio de la primera version del curso : Adaptibilidad e introduccion al curso dictada por Profesor principal</td>
			<td><%= course.getDateInicio() %></td>
		</tr>
		<% for (int i = 0;i<course.getActividades().size();i++) { %>
  			<% String s = (String)course.getActividades().get(i); %> 
		    <tr>
		      <th scope="row"><%= i+1 %></th>
		      <td><%= s %></td>
		       <td>Segun desarrollo de actividad <%= i+1 %></td>
		   </tr>
      	<%} %>
    <tr>
      <th scope="row">final</th>
   		<td>Actividad Final : Actividad- proyecto final dictada por el profesor principal</td>
       	
      	<td><%= course.getDateFinal() %></td>
    </tr>
  </tbody>
</table>
