       ...
       <div class="main_container">
          ...
          <div class="clearfix"></div>
           <div class="profile clearfix">
              ...
              <div class="profile_info">
               <span>Welcome,<h2>Anonimo</h2></span>
              </div>
            </div>
            <br />
          ...
          <div class="nav_menu">
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Anonimo   .  <span class=" fa fa-angle-down"></span>
                  </a>
        ...
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover table-bordered">
               Acceso denegado, debe iniciar sesion con una cuenta 
            </table>
			 <div class="clearfix">
