            ...
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <a href="/modules/add" class="btn btn-success"   data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Module</span></a>
			...
			<% if (modules.size() > 0) { %>
				<% for (int i = 0;i<modules.size();i++) { %>
					...
					<tr>
                        ...
                        <td><%= m.isStatus() %></td>
                    	    <td>
	                    	   <a href="modules/view?id=<%=m.getId()%>" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                               <a href="modules/edit?id=<%=m.getId()%>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                               <a href="modules/delete?id=<%=m.getId()%>"  onclick="return confirmar()" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                            </td>
            		</tr>
            	<%} %>   	 
			<%} %>   
