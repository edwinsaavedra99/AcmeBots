...
public class CoursesControllerAddActivity extends HttpServlet {	
	  			...
	  			if(userSearch.isEmpty()) {
		  			...
		  			if(rSearch.isEmpty()) {
				    	...
				    	if(aSearch.isEmpty()) {
				    	  ...
				    	  req.getRequestDispatcher("/WEB-INF/Views/Courses/actividad.jsp").forward(req, resp); 
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {   
			...
			Courses c = pm.getObjectById(Courses.class, k);  
			req.setAttribute("courses", c);
			c.getActividades().add(req.getParameter("name")+", "+req.getParameter("name")+"- " + req.getParameter("description"));
